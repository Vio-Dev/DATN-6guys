         ...
         <div class="container">
             ...
             <div class="p-t-40">
                 ...
                 <p class="stext-107 cl6 txt-center">
                     ...
                     <script>
                         document.write(new Date().getFullYear());
                     </script> Mọi quyền được bảo lưu | Được tạo ra với <i class="fa fa-heart-o"
                         aria-hidden="true"></i> bởi <a href="https://colorlib.com" target="_blank">Six guys</a> &amp;
                     được phân phối bởi <a href="https://themewagon.com" target="_blank">Six guys</a>
                     <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                 </p>
             </div>
         </div>
